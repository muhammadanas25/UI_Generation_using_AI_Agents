...
def _get_sys_prompt_template(blackboard: BlackBoard, additional_context: dict) -> str:
...
def get_chat_prompt(blackboard: BlackBoard, additional_context: dict) -> ChatPromptTemplate:
    sys_template = ("system", _get_sys_prompt_template(blackboard, additional_context))
