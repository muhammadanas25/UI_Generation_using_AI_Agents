  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-xl mx-auto text-base sm:text-lg md:text-xl lg:text-2xl text-gray-200 drop-shadow-lg">
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <div className="container mx-auto px-4 md:px-6 flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0">
