    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <footer className="bg-gray-900 text-white py-6">
        <div className="container mx-auto px-4 text-center">
          <p className="mb-4">&copy; {new Date().getFullYear()} SharpLook. All rights reserved.</p>
          <div className="flex flex-wrap justify-center space-x-4">
            <a href="#" className="hover:text-blue-400 transition-colors mb-2">Facebook</a>
            <a href="#" className="hover:text-blue-400 transition-colors mb-2">Twitter</a>
            <a href="#" className="hover:text-blue-400 transition-colors mb-2">Instagram</a>
          </div>
        </div>
      </footer>
    </div>
