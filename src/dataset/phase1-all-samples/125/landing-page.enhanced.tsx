      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container px-4 md:px-6">
            ...
            <div className="flex flex-col sm:flex-row overflow-x-auto space-y-6 sm:space-y-0 sm:space-x-8">
              {[1, 2, 3].map((i) => (
                <div key={i} className="w-full sm:min-w-[300px] bg-white dark:bg-gray-900 p-6 rounded-lg shadow-lg flex-shrink-0 animate-slide-in">
                  <p className="text-gray-700 dark:text-gray-300 mb-4">
                    "Chef's Choice has transformed my cooking experience with their high-quality products. Highly recommended!"
                  </p>
                  <div className="flex items-center">
                    <Image
                      src={`/customers/customer-${i}.jpg`}
                      alt={`Customer ${i}`}
                      width={40}
                      height={40}
                    ...
                    />
                    <div>
                      <p className="font-semibold text-gray-800 dark:text-gray-200">Customer {i}</p>
                      <p className="text-gray-500 dark:text-gray-400 text-sm">Home Cook</p>
                    </div>
                  </div>
                </div>
              ))}
