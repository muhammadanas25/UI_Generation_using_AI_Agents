...
export default function StyleCraftHomepage() {
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="flex flex-col sm:flex-row justify-center items-center gap-4 mt-8">
                ...
                />
                <Button variant="default" className="w-full sm:w-auto px-6 py-2">
                  Subscribe
                </Button>
              </div>
            </div>
      ...
      <footer className="flex flex-col sm:flex-row justify-between items-center space-y-4 sm:space-y-0 py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-gray-500">© 2024 StyleCraft. All rights reserved.</p>
        <nav className="flex space-x-4 order-1 sm:order-none">
