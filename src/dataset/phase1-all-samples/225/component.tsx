  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow">
        <section className="bg-gradient-to-r from-primary to-primary-foreground text-white py-12 sm:py-20">
          <div className="container mx-auto px-4 text-center">
            <h1 className="text-3xl sm:text-4xl font-bold mb-4">Decentralized Talent. Unlimited Potential.</h1>
            <p className="text-lg sm:text-xl mb-8">Join the future of work with WorkChain's blockchain-powered freelance marketplace.</p>
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <Button variant="secondary" size="lg" className="w-full sm:w-auto">Find Talent</Button>
              <Button variant="outline" size="lg" className="w-full sm:w-auto text-white border-white hover:bg-white hover:text-primary">Find Work</Button>
            </div>
          </div>
        </section>
        ...
        <section className="py-12 sm:py-20 bg-muted">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">Why Choose WorkChain?</h2>
        ...
        <section className="py-12 sm:py-20">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl sm:text-3xl font-bold text-center mb-8 sm:mb-12">Top Freelancers on WorkChain</h2>
        ...
        <section className="py-12 sm:py-20 bg-primary text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-2xl sm:text-3xl font-bold mb-4">Ready to Join the Revolution?</h2>
            <p className="text-lg sm:text-xl mb-8">Be part of the decentralized future of work. Sign up for WorkChain today!</p>
            <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
              <Input type="email" placeholder="Enter your email" className="max-w-xs bg-white text-primary" />
