...
import { Cube, Ticket, Users, Globe } from "lucide-react"
          ...
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="text-muted-foreground">Unique, verifiable, and tradeable NFT tickets for your events</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <Globe className="h-12 w-12 text-primary mb-4" />
                <h3 className="text-xl font-bold mb-2">Decentralized Platform</h3>
                <p className="text-muted-foreground">Powered by blockchain for transparency and security</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <Users className="h-12 w-12 text-primary mb-4" />
                <h3 className="text-xl font-bold mb-2">Community Governance</h3>
                <p className="text-muted-foreground">Participate in platform decisions with our governance token</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container px-4 md:px-6">
            <div className="grid items-center gap-6 lg:grid-cols-[1fr_500px] lg:gap-12 xl:grid-cols-[1fr_550px]">
              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl">NFT Ticketing Revolution</h2>
                ...
                <div className="flex flex-col gap-2 min-[400px]:flex-row">
                  ...
                  <Button variant="outline">Explore NFT Tickets</Button>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl">
                  Join the Web3 Event Revolution
                </h2>
