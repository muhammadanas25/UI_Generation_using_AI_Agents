    ...
    <div className="bg-green-50 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        <section className="mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-green-800 mb-6">Featured Posts</h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { icon: <Leaf className="w-8 h-8 text-green-600" />, title: "5 Easy Steps to Start Composting at Home" },
              { icon: <ShoppingBag className="w-8 h-8 text-green-600" />, title: "The Ultimate Guide to Sustainable Shopping" },
              { icon: <Recycle className="w-8 h-8 text-green-600" />, title: "Upcycling 101: Turning Trash into Treasure" },
            ].map((article, index) => (
              <div key={index} className="bg-white rounded-lg shadow-md p-6">
                <div className="flex items-center mb-4">
                  {article.icon}
                  <h3 className="text-base sm:text-lg font-semibold ml-2">{article.title}</h3>
                </div>
                <p className="text-gray-600 mb-4 text-sm sm:text-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
        ...
        <section className="bg-green-100 rounded-lg p-6 sm:p-8">
          <h2 className="text-2xl sm:text-3xl font-bold text-green-800 mb-4">Subscribe to Our Newsletter</h2>
          <p className="text-gray-700 mb-6 text-sm sm:text-base">Stay updated with the latest eco-friendly tips, sustainable living ideas, and exclusive content.</p>
          <form className="flex flex-col sm:flex-row gap-4">
            <Input type="email" placeholder="Enter your email" className="flex-grow" />
            <Button className="bg-green-800 text-white hover:bg-green-700 w-full sm:w-auto">Subscribe</Button>
          </form>
        </section>
      </main>
      ...
      <footer className="bg-green-800 text-white py-8">
        <div className="container mx-auto px-4">
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">About EcoSustainable</h3>
              <p className="text-sm">We're dedicated to promoting eco-conscious living and providing practical tips for a more sustainable lifestyle.</p>
            </div>
            <div>
