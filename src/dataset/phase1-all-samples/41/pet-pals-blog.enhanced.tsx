...
export default function PetPalsBlog() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {mobileMenuOpen && (
        <div className="sm:hidden bg-white dark:bg-gray-900 py-2">
          <nav className="flex flex-col space-y-2 px-4">
            <Link className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-indigo-500 transition-colors duration-200" href="#">
              Home
            </Link>
            <Link className="text-sm font-medium text-gray-600 dark:text-gray-300 hover:text-indigo-500 transition-colors duration-200" href="#">
              Pet Care
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center space-y-4 text-center">
              ...
              <div className="w-full max-w-md flex flex-col sm:flex-row items-center gap-4 animate-fadeIn">
      ...
      <footer className="container mx-auto px-4 lg:px-6 flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0 border-t">
